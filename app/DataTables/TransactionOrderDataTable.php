...
class TransactionOrderDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'transactionorder.action')
            ...
            // Filter Data using Invoice Number
    ...
    {
        return $this->builder()
            ->setTableId('transactionorder-table')
    ...
    {
        return 'TransactionOrder_' . date('YmdHis');
    }
}
