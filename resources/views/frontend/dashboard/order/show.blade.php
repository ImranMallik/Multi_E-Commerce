                            ...
                            <section class="invoice-print">
                                <div class="wsus__invoice_area">
                                    ...
                                    <div class="wsus__invoice_footer">
                                        ...
                                        <p><b>Sub Total: {{ $settings->currency_icon }}{{ $order->subtotal }}</b> </p>
                                        <p><b>Shipping Fee (+) :
                                                {{ $settings->currency_icon }}{{ $shipping->cost }}</b>
                                        </p>
                                        <p><b>Coupon (-) : {{ $settings->currency_icon }}{{ $coupon->discount }}</b> </p>
                                        <p><b>Total Amount : {{ $settings->currency_icon }}{{ $order->amount }}</b>
                                        </p>
