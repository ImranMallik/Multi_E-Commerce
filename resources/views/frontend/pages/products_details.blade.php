                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-xxl-5 col-md-6">
                                                <div class="wsus__vebdor_img">
                                                    <img src="{{ asset($product->getVendorId->banner) }}" alt="vensor"
                                                        class="img-fluid w-100">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                                                <div class="wsus__pro_det_vendor_text">
                                                    <h4>{{ $product->getVendorId->user->name }} </h4>
                                                    <p class="rating">
                                                        <i class="fas fa-star"></i>
                                                        <i class="fas fa-star"></i>
                                                        <i class="fas fa-star"></i>
                                                    ...
                                                    <p><span>Store Name:</span>{{ $product->getVendorId->shop_name }}</p>
                                                    <p><span>Address:</span>{{ $product->getVendorId->address }}</p>
                                                    <p><span>Phone:</span> {{ $product->getVendorId->phone }}</p>
                                                    <p><span>mail:</span>{{ $product->getVendorId->email }}</p>
                                                    <a href="vendor_details.html" class="see_btn">visit store</a>
                                                </div>
                                            </div>
                                            <div class="col-xl-12">
                                                <div class="wsus__vendor_details">
                                                    {!! $product->getVendorId->description !!}
